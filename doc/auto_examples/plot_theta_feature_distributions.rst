.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_plot_theta_feature_distributions.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_theta_feature_distributions.py:
...
.. image:: /auto_examples/images/sphx_glr_plot_theta_feature_distributions_001.png
...
.. image:: /auto_examples/images/sphx_glr_plot_theta_feature_distributions_002.png
    :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image:: /auto_examples/images/sphx_glr_plot_theta_feature_distributions_003.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_theta_feature_distributions_004.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_theta_feature_distributions_005.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_theta_feature_distributions_006.png
            :class: sphx-glr-multi-img
...
.. _sphx_glr_download_auto_examples_plot_theta_feature_distributions.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: plot_theta_feature_distributions.py <plot_theta_feature_distributions.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: plot_theta_feature_distributions.ipynb <plot_theta_feature_distributions.ipynb>`
